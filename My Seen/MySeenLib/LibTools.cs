...
namespace MySeenLib
{
    ...
    public static class EventcCalculationLogic
    {
        ...
        public static DateTime CalculateTo(EventsTypesBase.Indexes typeRepeat, DateTime beginDate, List<DateTime> skipTimes = null, IEnumerable<DateTime> skippedTimes = null)
        {
            bool first = true;
            var d = DateTime.Now;
            switch (typeRepeat)
            {
                ...
                case EventsTypesBase.Indexes.EveryMonthInNeedDayWithWhenSaturdayThenFridayWhenSundayThenMonday:
                    ...
                    do
                    {
                        if (!first)
                        {
                            if (skippedTimes == null) skippedTimes = new List<DateTime>();
                            skippedTimes = skippedTimes.Concat(new[] {d});
        ...
        public static IEnumerable<DateTime> GetSkippedTimes(EventsTypesBase.Indexes typeRepeat, DateTime beginDate, List<DateTime> skipTimes = null)
        {
        ...
        public static DateTime CalculateLast(EventsTypesBase.Indexes typeRepeat, DateTime beginDate)
        {
            var d = DateTime.Now;
            for (var i = 1; i < 100; i++)
            {
