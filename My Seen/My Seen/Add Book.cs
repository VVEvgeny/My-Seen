...
namespace My_Seen
{
    public partial class AddBook : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            NewFilm = _editId != 0 ? 
                new Books() { Id = _editId, UsersId = User.Id, Name = textBox1.Text, DateRead = dateTimePicker1.Value, DateChange = DateTime.Now, Rating = Defaults.Ratings.GetId(comboBox1.Text), Genre = Defaults.Genres.GetId(comboBox2.Text), Authors=textBox2.Text } : 
                new Books() { UsersId = User.Id, Name = textBox1.Text, DateRead = dateTimePicker1.Value, DateChange = DateTime.Now, Rating = Defaults.Ratings.GetId(comboBox1.Text), Genre = Defaults.Genres.GetId(comboBox2.Text), Authors = textBox2.Text };
            Hide();
        }
