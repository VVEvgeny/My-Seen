...
{
    public class TranslationDataSettings
    {
        public string Manage = Resource.Manage;
        public string ChangeYourAccountSettings = Resource.ChangeYourAccountSettings;
        public string Password = Resource.Password;
        public string ExternalLogins = Resource.ExternalLogins;
        public string SelectLanguage = Resource.SelectLanguage;
        public string RecordPerPage = Resource.RecordPerPage;
