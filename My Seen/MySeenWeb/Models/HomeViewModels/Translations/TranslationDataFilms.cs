...
{
    public class TranslationDataFilms
    {
        ...
        public string Seen = Resource.Seen;
        public string Share = Resource.Share;
        public string TitleAdd = Resource.Add + " " + Resource.Film;
        public string TitleEdit = Resource.Edit + " " + Resource.Film;
