...
[
    ...
    function($scope, $rootScope, $state, $stateParams, $http, $location, constants, $log, $anchorScroll) {
        ...
        $scope.calculate = function() {
            ...
            $scope.level = textBmi($scope.weight / (($scope.growth / 100) * ($scope.growth / 100)),
                $scope.sex,
                $scope.age);
            ...
            start = 0;
            end = parseInt(getBmi($scope.sex, $scope.age, bmis.DeadlineUnderweight) *
            (($scope.growth / 100) * ($scope.growth / 100)));
            color = "#FF0F00";
            bmi = $scope.translation.BMI + " <= " + getBmi($scope.sex, $scope.age, bmis.DeadlineUnderweight);
            dataProvider.push({
                "name": $scope.translation.DeadlineUnderweight,
                "start": start,
                "end": end,
                "color": color,
                "bmi": bmi
            ...
            start = end;
            end = parseInt(getBmi($scope.sex, $scope.age, bmis.LackOfWeight) *
            (($scope.growth / 100) * ($scope.growth / 100)));
            color = "#F8FF01";
            bmi = $scope.translation.BMI +
                " > " +
                getBmi($scope.sex, $scope.age, bmis.DeadlineUnderweight) +
                " & <= " +
                getBmi($scope.sex, $scope.age, bmis.LackOfWeight);
            dataProvider.push({
                "name": $scope.translation.LackOfWeight,
                "start": start,
                "end": end,
                "color": color,
                "bmi": bmi
            ...
            start = end;
            end = parseInt(getBmi($scope.sex, $scope.age, bmis.NormalWeight) *
            (($scope.growth / 100) * ($scope.growth / 100)));
            color = "#04D215";
            bmi = $scope.translation.BMI +
                " > " +
                getBmi($scope.sex, $scope.age, bmis.LackOfWeight) +
                " & <= " +
                getBmi($scope.sex, $scope.age, bmis.NormalWeight);
            dataProvider.push({
                "name": $scope.translation.NormalWeight,
                "start": start,
                "end": end,
                "color": color,
                "bmi": bmi
            ...
            start = end;
            end = parseInt(getBmi($scope.sex, $scope.age, bmis.Overweight) *
            (($scope.growth / 100) * ($scope.growth / 100)));
            color = "#F8FF01";
            bmi = $scope.translation.BMI +
                " > " +
                getBmi($scope.sex, $scope.age, bmis.NormalWeight) +
                " & <= " +
                getBmi($scope.sex, $scope.age, bmis.Overweight);
            dataProvider.push({
                "name": $scope.translation.Overweight,
                "start": start,
                "end": end,
                "color": color,
                "bmi": bmi
            ...
            start = end;
            end = parseInt(getBmi($scope.sex, $scope.age, bmis.ObesityClassI) *
            (($scope.growth / 100) * ($scope.growth / 100)));
            color = "#FF9E01";
            bmi = $scope.translation.BMI +
                " > " +
                getBmi($scope.sex, $scope.age, bmis.Overweight) +
                " & <= " +
                getBmi($scope.sex, $scope.age, bmis.ObesityClassI);
            dataProvider.push({
                "name": $scope.translation.ObesityClassI,
                "start": start,
                "end": end,
                "color": color,
                "bmi": bmi
            ...
            start = end;
            end = parseInt(getBmi($scope.sex, $scope.age, bmis.ObesityClassII) *
            (($scope.growth / 100) * ($scope.growth / 100)));
            color = "#FF0F00";
            bmi = $scope.translation.BMI +
                " > " +
                getBmi($scope.sex, $scope.age, bmis.ObesityClassI) +
                " & <= " +
                getBmi($scope.sex, $scope.age, bmis.ObesityClassII);
            dataProvider.push({
                "name": $scope.translation.ObesityClassII,
                "start": start,
                "end": end,
                "color": color,
                "bmi": bmi
            ...
            dataProvider.push({
                "name": $scope.translation.ObesityClassIII,
                "start": start,
                "end": end,
                "color": color,
                "bmi": bmi
